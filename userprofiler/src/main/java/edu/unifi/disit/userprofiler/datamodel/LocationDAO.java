...
public interface LocationDAO extends JpaRepository<Location, String> {
	...
	List<Location> findByDeviceDeviceId(String deviceId);

	List<Location> findByDeviceDeviceIdOrderByTimeDesc(String deviceId);

	Integer countByDeviceDeviceId(String deviceId);
