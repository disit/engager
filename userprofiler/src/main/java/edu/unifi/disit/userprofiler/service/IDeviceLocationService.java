...
public interface IDeviceLocationService {
	...
	Location getCurrentLocations(String deviceId, String lang);

	List<Location> getLocations(String deviceId, String lang, Integer page, Integer size, Date from, Date to);
