...
public class MyRestSuccessHandler
	...
	public MyRestSuccessHandler(IUserService userService) {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		logger.debug("{} login", userService.getLoggedUsername());

		// jwt header
		TokenAuthenticationService.addAuthentication(response, authentication.getName());

		userService.setLastLogin(new Date());
